<template>
    <header class="banner">
        ...
        <img src="../assets/imagens/foto-banner.png" alt="Foto de uma mulher cozinhando com uma bacia de vidro nas mãos. Ela está sorrindo e está apoiando um celular entre o seu rosto e o ombro" class="foto-banner">
    </header>
</template>
<style scoped>
.banner {
